...
import com.example.pdm2324i_gomoku_g37.helpers.InfoScreenTestTags.InfoFetchInfoErrorTag
...
fun InfoScreen(
    ...
    Scaffold(
        ...
        CustomContainerView(
            ...
            if (info is Loading)
                LoadingAlert(R.string.loading_api_info_title, R.string.loading_api_info_message)
...
fun InfoScreenPreview() {
    val info = "The Gomoku application is in version X.Y.Z\n and was made by Group 37 - Class 53D"
    GomokuTheme {
        InfoScreen(
            info = loaded(Result.success(info)),
