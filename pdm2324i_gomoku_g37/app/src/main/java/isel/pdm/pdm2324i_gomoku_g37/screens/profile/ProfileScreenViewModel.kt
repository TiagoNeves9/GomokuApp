...
class ProfileScreenViewModel(
    ...
    private val _userProfileFlow: MutableStateFlow<LoadState<User?>> = MutableStateFlow(
        idle()
    )
    ...
    private val _userStatisticFlow: MutableStateFlow<LoadState<UserStatistics?>> = MutableStateFlow(
        idle()
    )
