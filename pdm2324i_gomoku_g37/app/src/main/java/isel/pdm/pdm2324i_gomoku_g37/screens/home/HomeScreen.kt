...
import isel.pdm.pdm2324i_gomoku_g37.screens.components.HOME_FONT_SIZE
import isel.pdm.pdm2324i_gomoku_g37.screens.components.HOME_USERNAME_FONT_SIZE
...
fun HomeScreen(
    ...
    val menu: List<MenuOption> = listOf(
        MenuOption(
            ...
            stringResource(id = R.string.menu_play_option)
        ),
        MenuOption(
            onRankingsRequested,
            Icons.Default.Star,
            stringResource(id = R.string.menu_rankings_option)
        ),
        MenuOption(
            onAuthorsRequested,
            Icons.Default.Face,
            stringResource(id = R.string.menu_authors_option)
        ),
        MenuOption(
            onProfileRequest,
            Icons.Default.PermIdentity,
            stringResource(id = R.string.menu_profile_option)
        )
    )
    ...
    Scaffold(
        topBar = {
            CustomBar(
                text = stringResource(R.string.activity_home_top_bar_title),
