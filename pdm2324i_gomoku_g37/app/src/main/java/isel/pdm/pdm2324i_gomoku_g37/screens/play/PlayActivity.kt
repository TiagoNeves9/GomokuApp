...
import isel.pdm.pdm2324i_gomoku_g37.screens.game.GameActivity
import isel.pdm.pdm2324i_gomoku_g37.screens.info.InfoActivity
import isel.pdm.pdm2324i_gomoku_g37.screens.new_lobby.NewLobbyActivity
...
class PlayActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val currentScreenState: LobbyScreenState =
